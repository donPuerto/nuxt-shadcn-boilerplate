<template>
  <div class="grid gap-6">
    ...
    <div class="space-y-1.5">
      <Label>{{ $t('themeCustomizer.categories.color') }}</Label>
      ...
      <!-- <div class="grid grid-cols-3 gap-2">
        ...
        >
          ...
          <span class="text-xs capitalize">{{ $t('themeCustomizer.theme.light') }}</span>
        </Button>
        ...
        >
          ...
          <span class="text-xs capitalize">{{ $t('themeCustomizer.theme.dark') }}</span>
        </Button>
        ...
        >
          ...
          <span class="text-xs capitalize">{{ $t('themeCustomizer.theme.system') }}</span>
        </Button>
      </div> -->
    </div>
  </div>
